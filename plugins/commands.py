...
async def start(client, message):
    ...
    if len(message.command) != 2:
        buttons = [[
            ...
            InlineKeyboardButton('📥 Movie Channel 📥', url=f"https://t.me/xDEADPOOLCINEMA"),
            InlineKeyboardButton('🎭 Mods Channel 🎭', url='https://t.me/xDEADPOOLMODz')
            ],[
    ...
    await client.send_cached_media(
        ...
        file_id=file_id,
        caption=f_caption,
        reply_markup=InlineKeyboardMarkup( [ [InlineKeyboardButton('sᴜʙsᴄʀɪʙᴇ', url='https://youtube.com/@xDEADPOOL')] ] ),
        protect_content=True if pre == 'filep' else False,
        )
